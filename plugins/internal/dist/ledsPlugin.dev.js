...
function blinkLED() {
  var blinkLed = function blinkLed(_) {
    if (stopBlinking) {
      return; //return actuator.unexport();
    }

    actuator.read(function (err, value) {
      led1state = value ^ 1; // Asynchronous read

      if (err) {
        throw err;
      }

      actuator.write(value ^ 1, function (err) {
        // Asynchronous write
        if (err) {
          throw err;
        }
...
//# sourceMappingURL=ledsPlugin.dev.js.map
